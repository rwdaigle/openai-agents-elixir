defmodule OpenAI.Agents.Integration.GuardrailsTest do
  ...
  defmodule MathOnlyGuardrail do
    ...
    def validate_input(input, _context) do
      ...
      if String.match?(input_text, ~r/math|calculate|number|equation|add|subtract|multiply|divide|\+|-|\*|\/|\d+/i) do
        :ok
      else
  ...
  defmodule BriefAgent do
    ...
    def configure do
      %{
        name: "brief_agent",
        instructions: "You give very brief responses. Always respond in less than 100 characters.",
