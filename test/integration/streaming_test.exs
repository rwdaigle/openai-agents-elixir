defmodule OpenAI.Agents.Integration.StreamingTest do
  ...
  defmodule ThemedStoryTeller do
    ...
    def configure do
      %{
        ...
        instructions:
          "You are a storyteller. First get a theme, then tell a very short story about it.",
  ...
  describe "streaming responses" do
    ...
    test "stream returns enumerable of events" do
      stream =
        OpenAI.Agents.stream(StoryTeller, "Tell me a story about a brave rabbit in 2 sentences")
